...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-5">
				<img src="image/<%=rs.getString("p_filename")%>" alt="image" style="width: 100%" />
			</div>
			<div class="col-md-7">
